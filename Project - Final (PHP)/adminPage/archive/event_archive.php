                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align: end;">
                                <div class="add-button">
                                    <a class='btn btn-light border border-light btn active" data-bs-toggle="button" aria-pressed="true"' href='./alumni_archive.php' style="padding-left: 48px; padding-right: 48px; margin-right: 1%;">Alumni</a>
                                    <a class='btn btn-light border border-light' href='./coor_archive.php' style="padding-left: 30.7px; padding-right: 30.7px; margin-right: 1%;">Coordinator</a>
